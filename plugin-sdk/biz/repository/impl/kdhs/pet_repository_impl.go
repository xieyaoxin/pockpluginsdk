...
var PetRepositoryImpl4KDHS = &petRepositoryImpl4KDHS{}

type petRepositoryImpl4KDHS struct{}

func (instance *petRepositoryImpl4KDHS) GetCarriedPets() ([]*model.Pet, error) {
	Pets := []*model.Pet{}
...
func (*petRepositoryImpl4KDHS) GetPetDetail(PetId string) (*model.Pet, error) {
	params := util.InitParam()
	params["id"] = PetId
...
func (*petRepositoryImpl4KDHS) GetPetSkillList(PetId string) ([]*model.Skill, error) {
